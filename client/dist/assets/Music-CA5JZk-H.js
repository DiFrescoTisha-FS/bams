import{r as s,p as n,m as i,P as e,u,j as o,I as h,M as c,S as f,B as x,a as b,b as w}from"./index-BYymD1Vh.js";const y=(t=768)=>{const[a,d]=s.useState(window.innerWidth<=t);return s.useEffect(()=>{const r=()=>{d(window.innerWidth<=t)};return window.addEventListener("resize",r),()=>window.removeEventListener("resize",r)},[t]),a},$=n.div`
  display: flex;
